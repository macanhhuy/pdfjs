...
(function mozPrintCallbackPolyfillClosure() {
    ...
    // huymac 2016-02-15
    window.addEventListener('keydown2', function (event) {
...
var PDFFindController = (function PDFFindControllerClosure() {
    ...
    PDFFindController.prototype = {
        ...
        prepareMatches: function PDFFindController_prepareMatches(matchesWithLength, matches, matchesLength) {
            ...
            for (i = 0, len = matchesWithLength.length; i < len; i++) {
                ...
                matches.push(matchesWithLength[i]);
        ...
        calcFindMatch: function PDFFindController_calcFindMatch(pageIndex) {
            ...
            function searchTerm(str, term, startIndex) {
                var regexp = new RegExp('\\b' + query + '\\b', 'igm');
                ...
                if (!res) {
                    ...
                    return regexp.lastIndex - res[0].length;
                }
            ...
            function addMatches(query) {
                ...
                query = query.replace(/"|\*/igm, '');
                var queryLen = query.length;
                var matchIdx = -queryLen;
                var regexp = new RegExp('\\b' + query + '\\b', 'igm');
                while (true) {
                    matchIdx = pageContent.regexIndexOf(regexp, matchIdx + queryLen);
                    if (matchIdx === -1) {
                        return;
                    }
            ...
            var full_keywords = [];
            query.split(/\band\b|\bor\b|\bnot\b/igm).forEach(function processKeyword(keyword) {
                if (keyword.trim().search(/^"(.*)"$/igm) !== -1) {
                    full_keywords.push(keyword.replace(/"|\*/igm, '').toLowerCase().trim());
                }
            });

            var keywords = query.replace(/\sand\s/g, ' ').replace(/\sor\s/g, ' ').replace(/\snot\s/g, ' ').split(/\s+/);
            if (full_keywords.length === 0) {
                full_keywords = keywords;
            }

            full_keywords.forEach(addMatches);
...
var SecondaryToolbar = {
    ...
    initialize: function secondaryToolbarInitialize(options) {
        ...
        var self = this;
        // huymac 2016-02-17
        document.addEventListener('callDocumentProperties', function(){
            PDFViewerApplication.pdfDocumentProperties.getProperties();
        });
...
var PDFDocumentProperties = (function PDFDocumentPropertiesClosure() {
    ...
    PDFDocumentProperties.prototype = {
        ...
        getProperties: function PDFDocumentProperties_get() {
            ...
            this.pdfDocument.getMetadata().then(function (data) {
                ...
                window.documentProperties = content;
                var event = new Event('documentProperties');
        ...
        _getProperties: function PDFDocumentProperties_getProperties() {
            ...
            this.pdfDocument.getMetadata().then(function (data) {
                ...
                console.log('_getProperties', content);
            }.bind(this));
        },
        ...
        cssTransform: function PDFPageView_transform(canvas, redrawAnnotations) {
            ...
            var cssTransform = 'rotate(' + relativeRotation + 'deg) ' +
                ...
                if ( typeof CustomStyle === 'function') {
                    PDFJS.CustomStyle.setProp('transform', canvas, cssTransform);
                }
            ...
            if (this.textLayer) {
                ...
                PDFJS.CustomStyle.setProp('transform', textLayerDiv,
    ...
    TextLayerBuilder.prototype = {
        ...
        render: function TextLayerBuilder_render(timeout) {
            ...
            this.textLayerRenderTask.promise.then(function () {
                ...
                var query = document.getElementById('top-search').value.toLowerCase();
                var full_keywords = [];
                query.split(/\band\b|\bor\b|\bnot\b/igm).forEach(function processKeyword(keyword) {
                    if (keyword.trim().search(/^"(.*)"$|^“(.*)“$/igm) !== -1) {
                        full_keywords.push(keyword.replace(/"|\*|“/igm, '').toLowerCase().trim());
                ...
                angular.forEach(full_keywords, function removeFullKeyword(keyword) {
                    query = query.replace(keyword, '');
                });

                var keywords = query.replace(/"|\*|“/igm, '').replace(/\band\b|\bor\b|\bnot\b/igm, ' ').split(/\s+/);
...
//                    $(textDiv).highlight(full_keywords, {
//                        caseSensitive: false, wordsOnly: true, className: 'full-keyword cfr-highlight'
//                    });
//
//                    $(textDiv).highlight(keywords, {
//                        caseSensitive: false, wordsOnly: true, className: 'cfr-highlight'
//                    });
//
//                    var text = '';
//
...
//                            var value = keyword.split(/\s+/);
//                            for (var i = value.length; i > 0; i--) {
//                                text = value.slice(0, i + 1).join(' ');
//                                $(textDiv).highlight(text, {
//                                    caseSensitive: false, wordsOnly: true, className: 'from-full-keyword cfr-highlight'
//                                });
//                            }
//
//                            var value2 = keyword.split(/\s+/);
//                            for (var j = 0; j < value2.length; j++) {
//                                text = value2.slice(j, value2.length).join(' ');
//                                $(textDiv).highlight(text, {
//                                    caseSensitive: false, wordsOnly: true, className: 'from-full-keyword cfr-highlight'
//                                });
//                            }
...
//                    });
        ...
        convertMatches: function TextLayerBuilder_convertMatches(matches) {
            ...
            for (var m = 0, len = matches.length; m < len; m++) {
                ...
                matchIdx += matches[m].matchLength;
...
var PDFOutlineView = (function PDFOutlineViewClosure() {
    ...
    PDFOutlineView.prototype = {
        ...
        render: function PDFOutlineView_render() {
            ...
            var queue = [
                { parent: fragment, items: this.outline }
            ];
...
//                }
                ...
                var event = new Event('callDocumentProperties');
                document.dispatchEvent(event);
        ...
        pdfDocument.getMetadata().then(function (data) {
            ...
            var event = new Event('reloadAnnotation');
            document.dispatchEvent(event);
            var pdfTitle;
...
function webViewerLoad(file_url, evt) {
    DEFAULT_URL = file_url;
...
//huymac 03-03-2016
document.addEventListener('gotoPage', function gotoPage(evt) {
    PDFViewerApplication.pdfViewer.scrollPageIntoView(evt.detail);
    var event = new CustomEvent('reloadAnnotation', {detail: false});
     document.dispatchEvent(event);
}, true);
...
function handleMouseWheel(evt) {
    ...
    var pdfViewer = window.pdfViewer = PDFViewerApplication.pdfViewer;
...
// huymac 2016-02-15
window.addEventListener('keydown2', function keydown(evt) {
    if (OverlayManager.active) {
        return;
    }
